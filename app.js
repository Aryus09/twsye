  ...
  if (err) {
   ...
   db.get('SELECT domain, nama_server FROM Server WHERE id = ?', [serverId], async (err, rowServer) => {
     if (!err && rowServer) {
       ...
       // Kirim pesan sukses biasa (TANPA FILE) tapi pakai 3 Tombol
       await ctx.reply(msg, { 
         parse_mode: 'Markdown',
         reply_markup: {
           inline_keyboard: [
             ...
             [
               // Tombol ke-3 untuk request file .ziv
   ...
   // ====================================
           ...
           // [KODE SEBELUMNYA] Kirim pesan sukses BESERTA 2 tombol salin terpisah
       await ctx.reply(msg, { 
         parse_mode: 'Markdown',
         reply_markup: {
           inline_keyboard: [
